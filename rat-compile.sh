...
echo "Compiling avocado-rat for target: $RUST_TARGET"
...
cargo build --release --bin avocado-rat --target "$RUST_TARGET" --target-dir "$AVOCADO_BUILD_DIR"

echo "avocado-rat compiled successfully"
